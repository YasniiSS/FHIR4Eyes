# IntraocularPressureRightEyeExample - FHIR4Eyes - A Proposed FHIR Implementation Guide for Ophthalmology v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **IntraocularPressureRightEyeExample**

## Example Observation: IntraocularPressureRightEyeExample
...
```json
{
  ...
  "id" : "IntraocularPressureRightEyeExample",
  "meta" : {
