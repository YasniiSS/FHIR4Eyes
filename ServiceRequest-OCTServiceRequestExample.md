# OCTServiceRequestExample - FHIR4Eyes - A Proposed FHIR Implementation Guide for Ophthalmology v0.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **OCTServiceRequestExample**

## Example ServiceRequest: OCTServiceRequestExample
...
**code**: Optical coherence tomography, RNFL and macula, both eyes
...
```json
{
  ...
  "code" : {
    "text" : "Optical coherence tomography, RNFL and macula, both eyes"
  },
  "subject" : {
