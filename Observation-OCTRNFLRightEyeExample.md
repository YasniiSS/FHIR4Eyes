# OCTRNFLRightEyeExample - FHIR4Eyes - A Proposed FHIR Implementation Guide for Ophthalmology v0.1.0
...
> **component****code**: RNFL superior thickness**value**: 107 um (Details: UCUM codeum = 'um')

> **component****code**: RNFL inferior thickness**value**: 122 um (Details: UCUM codeum = 'um')

> **component****code**: RNFL nasal thickness**value**: 66 um (Details: UCUM codeum = 'um')

> **component****code**: RNFL temporal thickness**value**: 54 um (Details: UCUM codeum = 'um')

> **component****code**: RNFL average thickness**value**: 88 um (Details: UCUM codeum = 'um')

> **component****code**: Overall classification**value**: Borderline
